...
const List = () => {
    ...
    const fetchList = async () => {
        try {
            const response = await axios.get('https://food-delivery-api-tau.vercel.app/api/food/list');
    ...
    const removeFood = async (foodId) => {
        try {
            const response = await axios.post('https://food-delivery-api-tau.vercel.app/api/food/remove', { id: foodId });
